...
function BecomePartner() {
  ...
  return <div className="min-h-screen py-8 px-4 sm:px-6 lg:px-8">
    ...
    /* Benefits */
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6 mb-16">
          {benefits.map((benefit) => <GlassCard key={benefit.title} className="p-6 text-center" hover>
          ...
          <div className="flex items-center justify-between mb-12">
            {steps.map((step, index) => <div key={step.number} className="flex items-center flex-1">
                <div className="flex flex-col items-center flex-1">
                  <div
    className={`w-12 h-12 rounded-full flex items-center justify-center mb-2 ${currentStep >= step.number ? "bg-[#D4AF37] text-black" : "bg-white/5 text-white/40"}`}
  >
                ...
                {index < steps.length - 1 && <div className={`h-0.5 flex-1 ${currentStep > step.number ? "bg-[#D4AF37]" : "bg-white/10"}`} />}
              </div>)}
          </div>
  ...
  />
            ...
            {currentStep === 2 && <div className="space-y-6">
                ...
                <div className="space-y-4">
                  {["Ceramic Coating", "PPF", "Paint Correction", "Interior Detailing", "Exterior Detailing"].map((service) => <div key={service} className="p-4 bg-white/5 rounded-lg">
  ...
  />
            ...
            {currentStep === 4 && <div className="space-y-6">
                ...
                <div className="space-y-4">
                  {["Business Registration", "GST Certificate", "Identity Proof", "Address Proof"].map((doc) => <div key={doc} className="p-4 bg-white/5 rounded-lg">
  ...
  />
            ...
            <div className="flex gap-4 mt-8">
              {currentStep > 1 && <Button variant="outline" onClick={() => setCurrentStep(currentStep - 1)} className="flex-1">
                  Previous
                </Button>}
              <Button
