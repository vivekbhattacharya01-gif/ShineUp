...
function AIDiagnosticReport() {
        ...
        <div className="flex flex-col md:flex-row md:items-center justify-between mb-8 gap-4">
          <div>
            <h1 className="text-4xl mb-2">
              AI Diagnostic <span className="text-primary">Report</span>
            </h1>
  ...
  >
                ...
                <div className="text-center">
                  ...
                  <h3 className="font-semibold mb-1">
                    {report.issues.reduce((acc, cat) => acc + cat.items.length, 0)}{" "}
                    Issues
                  </h3>
                  <p className="text-sm text-foreground/60">
                    {report.severityScore} Severity
                  </p>
                </div>
    ...
    /* Detected Issues */
            ...
            <GlassCard className="p-8">
              ...
              <div className="space-y-6">
                {report.issues.map((category, catIndex) => <div key={catIndex}>
    ...
    /* Recommendations */
            ...
            <GlassCard className="p-8">
              ...
              <div className="space-y-3">
                {report.recommendations.map((rec, index) => <div key={index} className="flex items-start gap-3">
  ...
  >
    ...
    return <div key={index}>
                      ...
                      <Progress
      value={categoryTotal / report.totalEstimatedCost * 100}
      className="h-2"
    />
                    </div>;
  })}
    ...
    /* Nearby Providers */
            ...
            <GlassCard className="p-6">
              ...
              <div className="space-y-4">
                {report.nearbyProviders.map((provider) => <div
    key={provider.id}
              ...
              <div className="flex items-start gap-3">
                ...
                <div>
                  ...
                  <p className="text-xs text-foreground/70">
                    Cost estimates are approximate and may vary based on your
                    location and chosen service provider. Final pricing will be
