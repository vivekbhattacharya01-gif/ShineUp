...
function AIVehicleInspection() {
  ...
  const isComplete = Object.keys(uploadedImages).length === requiredImages.length;
  return <div className="min-h-screen pt-24 pb-12">
    ...
    className={cn(
      ...
      vehicleType === "car" ? "border-primary bg-primary/10" : "border-[var(--glass-border)] hover:border-primary/50"
    )}
  >
    ...
    className={cn(
      "cursor-pointer rounded-xl p-6 border-2 transition-all",
      vehicleType === "bike" ? "border-primary bg-primary/10" : "border-[var(--glass-border)] hover:border-primary/50"
    )}
  >
  ...
  >
          ...
          <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-6 mb-8">
            {requiredImages.map((image) => <div key={image.key}>
                <label
    htmlFor={image.key}
    className={cn(
      "block aspect-video rounded-xl border-2 border-dashed cursor-pointer transition-all relative overflow-hidden",
      uploadedImages[image.key] ? "border-primary bg-primary/10" : "border-[var(--glass-border)] hover:border-primary/50 bg-secondary/20"
    )}
  >
                  {uploadedImages[image.key] ? <div className="w-full h-full flex items-center justify-center bg-green-500/10">
                      <div className="text-center">
                        <Check className="h-12 w-12 text-green-500 mx-auto mb-2" />
                        <p className="text-sm text-green-500">Uploaded</p>
                      </div>
                    </div> : <div className="w-full h-full flex flex-col items-center justify-center p-4">
  ...
  >
    ...
    /* Analyze Button */
        ...
        {!isAnalyzing ? <div className="flex justify-center">
            <Button
    size="lg"
  ...
  ].map((feature, index) => <GlassCard key={index} className="p-6 text-center">
