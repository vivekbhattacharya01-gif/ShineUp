  ...
  const [messages, setMessages] = useState([
    {
      role: "assistant",
      content:
        "Hi there! Ask me anything about vehicle care, service booking, or maintenance.",
    },
  ]);
    ...
    try {
      ...
      setMessages((prev) => [
        ...prev,
        {
          role: "assistant",
          content:
            "I couldn't fetch a response right now. Please check your Gemini API key and try again.",
        },
      ]);
    } finally {
      setLoading(false);
          ...
          <div className="space-y-6">
            <div className="rounded-[2rem] border border-white/10 bg-white/5 p-8 shadow-2xl shadow-black/20 backdrop-blur-xl">
              ...
              <h1 className="mt-6 text-4xl font-bold tracking-tight sm:text-5xl">
                Ask ShineUp for care tips, booking advice, or vehicle inspection guidance.
              </h1>

              <p className="mt-4 max-w-2xl text-lg text-slate-300">
                Get instant assistance on maintenance schedules, partner recommendations,
                and how to keep your vehicle running smoothly.
              </p>
            </div>
            ...
            <div className="rounded-[2rem] border border-white/10 bg-slate-950/90 p-6 shadow-2xl shadow-black/20 backdrop-blur-xl">
              ...
              <ul className="mt-4 space-y-3 text-slate-300">
                ...
                <li>• Configure your Gemini API key in the .env file.</li>
              </ul>
            </div>
          </div>
          ...
          <div className="rounded-[2rem] border border-white/10 bg-slate-950/95 p-6 shadow-2xl shadow-black/30 backdrop-blur-xl">
            <div className="flex items-center justify-between gap-4">
              <div>
                ...
                <h3 className="mt-2 text-2xl font-semibold">
                  Interactive Car Assistant
                </h3>
              </div>

              <span className="rounded-full bg-[#D4AF37]/10 px-3 py-1 text-sm text-[#FFD700]">
                Live
              </span>
            </div>
            ...
            <form onSubmit={handleSubmit} className="mt-6 flex flex-col gap-4">
              <textarea
                ...
                placeholder="Ask about vehicle care, detailing, maintenance..."
